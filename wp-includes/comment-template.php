...
function comment_form( $args = array(), $post_id = null ) {
	...
	$defaults = array(
		'fields'               => $fields,
		'comment_field'        => '<div class="comment-form-comment w-100"><input type="text" id="comment" class="form-control" name="comment" required="required" autocomplete="off" placeholder="Add Todo ..." /></div>',
		...
		'label_submit'         => __( 'Add Todo' ),
		'submit_button'        => '<input name="%1$s" type="submit" id="%2$s" class="%3$s btn btn-info" value="%4$s" />',
